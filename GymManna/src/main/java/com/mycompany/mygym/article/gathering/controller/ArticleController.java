...
public class ArticleController {
	...
	public HashMap<Object, Object> searchListHandler(@RequestParam("centerName") String centerName, @RequestParam("articleGnum") Long articleGnum, Model model) {
	...
	public ResponseEntity<List<Gathering>> createArticle(@RequestParam String title,@RequestParam String content,@RequestParam String category ,@RequestParam String userId ,@RequestParam String centerName, Model model) {
	...
	public ResponseEntity<Gathering> updateArticle(@RequestParam Long articleGnum,
			@RequestParam String title,@RequestParam String content,@RequestParam String centerName, Model model) {
...
//    }
    ...
    @RequestMapping(value="qrCode" , produces = "application/json; charset=UTF-8")
    public String makeqr(HttpServletRequest request, HttpSession session,@RequestParam Long articleGnum) throws WriterException, IOException{
